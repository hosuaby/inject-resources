...
public class ResourceLoaderTests {
    ...
    public void testReadAsByteArray() {
        ...
        /* Given */
        String resourcePath = "/com/adelean/junit/jupiter/fibonacci.bin";
        ResourceLoader resourceLoader = new ResourceLoader(ResourceLoaderTests.class);
    ...
    public void testTryToLoadMissingResource() {
        ...
        /* Given */
        String resourcePath = "/com/adelean/junit/jupiter/missing.file";
        ResourceLoader resourceLoader = new ResourceLoader(ResourceLoaderTests.class);
        ...
        assertThatCode(tryToLoadResource)
                ...
                .hasMessage("Resource 'com/adelean/junit/jupiter/missing.file' is missing.");
    }
}
